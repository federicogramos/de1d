...
enum e_mem {MEM_PUL_S,MEM_PUL_M,MEM_PUL_H,MEM_PUL_S2,MEM_PUL_M2,MEM_PUL_H2,CANT_MEM};

//FGR: SE ENCUENTRA REPETIDA EN EL MAIN
#define CANT_DIGITS 2//FGR: CANTIDAD DIGITOS DE VARIABLES EN MEMORIA (N DIGITOS QUE TENGO QUE INGRESAR EN LA CONFIGURACION PARA CADA VARIABLE)
